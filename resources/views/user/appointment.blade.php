    ...
    <form class="main-form" action="{{url('appointment')}}" method="POST">
        ...
        <div class="row mt-5 ">
          <div class="col-12 col-sm-6 py-2 wow fadeInLeft">
            {{-- later automatically get from user  --}}
        ...
        <button type="submit" style="background-color: #00D9A5" class="btn btn-primary mt-3 wow zoomIn text-center">Submit Request</button>
    </form>
    </div>
  </div> <!-- .page-section -->
